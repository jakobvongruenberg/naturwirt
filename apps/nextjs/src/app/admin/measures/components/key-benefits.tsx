...
const KeyBenefits = () => {
  ...
  const label = t('Measure.Label.KeyBenefits')
  const description = t('Measure.Label.KeyBenefitsDescription')
  const placeholder = t('Measure.Placeholder.EnterBenefit')
  const button = t('Measure.Button.AddBenefit')
  const name = 'keyBenefits'
  ...
  const errorMessage = formState.errors[name]?.root?.message
