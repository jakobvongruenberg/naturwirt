...
import type { SendResetPasswordMailSchema } from '@farmers/validators/mail'
import { env } from '@farmers/env'

const isLocalDevelopment = process.env.NODE_ENV !== 'production'
export enum Templates {
  resetPasswordGerman = 'reset-password-de',
  resetPasswordEnglish = 'reset-password-en',
}

export const DefaultSubject: { [key in Templates]?: string } = {
  [Templates.resetPasswordGerman]: 'Setzen Sie Ihr Passwort zurück',
  [Templates.resetPasswordEnglish]: 'Reset your password',
}
...
export interface TemplateType {
  [Templates.resetPasswordGerman]: z.infer<typeof SendResetPasswordMailSchema>
  [Templates.resetPasswordEnglish]: z.infer<typeof SendResetPasswordMailSchema>
}
